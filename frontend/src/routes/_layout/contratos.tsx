...
function ContratosPage() {
  ...
  return (
    <div className="min-w-0 space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            O saldo controlado é quantitativo e monetário em cada item do contrato.
          </p>
        </div>
        {isAdmin && (
          <button
      ...
      <TableScroll>
        <table className="w-full min-w-[60rem] text-sm text-left">
          <thead className="bg-slate-50 dark:bg-slate-950 border-b dark:border-slate-800 text-slate-600 dark:text-slate-400 font-medium">
            <tr>
              ...
              <th className="px-6 py-4 text-right whitespace-nowrap">Saldo atual</th>
                            ...
                            <table className="w-full min-w-[44rem] text-xs">
                              <thead className="text-slate-500">
                                <tr>
                                  ...
                                  <th className="py-2 text-right font-medium whitespace-nowrap">Saldo total</th>
                                  ...
                                  return (
                                    <tr key={item.id}>
                                      ...
                                      <td className="py-2 text-right font-semibold text-slate-800 dark:text-slate-100 whitespace-nowrap">
                                        <p>{formatarMoeda(saldoMonetarioItem(item))}</p>
                              ...
                              <tfoot>
                                <tr className="font-semibold text-slate-800 dark:text-slate-100">
                                  <td className="py-2 pr-4">Saldo do contrato</td>
                                  <td className="py-2 text-right text-slate-600 dark:text-slate-400 whitespace-nowrap">
                                    {totais.qtdContratada.toLocaleString("pt-BR")}
                                  </td>
